...
from .serializers import (
    ...
    LoginLogListSerializer,
    PrivateProfileSerializer,
    CountyIPBlockSerializer,
    CountyIPBlockCreateSerializer,
)
from .models import (
    User,
    ConfirmPhoneNumber,
...
class ConfirmEmailView(APIView):
    ...
    secured_key_param_config = openapi.Parameter(
        "secured_key",
        in_=openapi.IN_QUERY,
        description="Secured_key",
        type=openapi.TYPE_STRING,
    )

    # 이메일 인증 확인
    @swagger_auto_schema(
        manual_parameters=[secured_key_param_config],
...
class SendPhoneNumberView(APIView):
    ...
    @swagger_auto_schema(
        operation_summary="아이디 찾기 휴대폰 sms 발송",
