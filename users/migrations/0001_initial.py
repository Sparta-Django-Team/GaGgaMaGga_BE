...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_image', models.ImageField(default='default_profile_pic.jpg', upload_to='profile_pics', validators=[django.core.validators.validate_image_file_extension], verbose_name='프로필 사진')),
                ...
                ('review_cnt', models.PositiveIntegerField(default=0, verbose_name='리뷰수')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('update_ip', models.GenericIPAddressField(null=True, validators=[django.core.validators.validate_ipv46_address], verbose_name='로그인한 IP')),
