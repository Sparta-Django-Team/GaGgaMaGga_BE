# Generated by Django 4.1.3 on 2022-12-23 17:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('updated_ip', models.GenericIPAddressField(null=True, validators=[django.core.validators.validate_ipv46_address], verbose_name='로그인한 IP')),
                ('country', models.CharField(max_length=255, null=True, verbose_name='로그인한 국가')),
        ...
        migrations.CreateModel(
            name='BlockedCountryIP',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('country', models.CharField(error_messages={'unique': '이미 차단된 국가코드입니다.'}, max_length=255, null=True, unique=True, verbose_name='차단한 국가')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='차단한 일자')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='회원')),
            ],
            options={
                'ordering': ['-created_at'],
