    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review_image_one', models.ImageField(blank=True, upload_to='review_pics', validators=[django.core.validators.validate_image_file_extension], verbose_name='이미지 1')),
                ('review_image_two', models.ImageField(blank=True, upload_to='review_pics', validators=[django.core.validators.validate_image_file_extension], verbose_name='이미지 2')),
                ('review_image_three', models.ImageField(blank=True, upload_to='review_pics', validators=[django.core.validators.validate_image_file_extension], verbose_name='이미지 3')),
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='작성자')),
                ('place', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='place_review', to='places.place', verbose_name='장소')),
