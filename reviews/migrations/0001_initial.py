        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "review_image_one",
                    models.ImageField(
                        blank=True, upload_to="review_pics", verbose_name="이미지 1"
                    ),
                ),
                (
                    "review_image_two",
                    models.ImageField(
                        blank=True, upload_to="review_pics", verbose_name="이미지 2"
                    ),
                ),
                (
                    "review_image_three",
                    models.ImageField(
                        blank=True, upload_to="review_pics", verbose_name="이미지 3"
                    ),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="후기 생성 시간"),
                ),
                (
                    "updated_at",
                    models.DateTimeField(auto_now=True, verbose_name="후기 수정 시간"),
                ),
                (
                    "rating_cnt",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=30,
                        verbose_name="신고 카테고리",
                    ),
                ),
                (
                    "content",
                    models.TextField(blank=True, max_length=500, verbose_name="신고 내용"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="생성 시간"),
