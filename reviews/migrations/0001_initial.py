# Generated by Django 4.1.3 on 2022-12-23 17:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='리뷰 생성 시간')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='리뷰 수정 시간')),
                ...
                ('review_like', models.ManyToManyField(blank=True, related_name='like_review', to=settings.AUTH_USER_MODEL, verbose_name='리뷰 좋아요')),
            ],
            options={
                'db_table': 'review',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(max_length=500, verbose_name='신고 내용')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='생성 시간')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='작성자')),
                ...
                ('review', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='reviews.review', verbose_name='리뷰')),
            ],
            options={
                'db_table': 'reports',
                'ordering': ['created_at'],
        ...
        migrations.AddField(
            model_name='comment',
            name='review',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='review_comments', to='reviews.review', verbose_name='리뷰'),
        ),
    ]
