...
urlpatterns = [
    ...
    path('new/<int:place_id>/', views.NewUserPlaceListView.as_view(), name='new_user_place_list_view'),
    path('selection/', views.PlaceSelectView.as_view(), name="place_select_view"),
