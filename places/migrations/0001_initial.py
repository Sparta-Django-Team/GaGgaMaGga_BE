    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.IntegerField(blank=True, null=True, verbose_name='위도')),
                ('longitude', models.IntegerField(blank=True, null=True, verbose_name='경도')),
                ('munu', models.CharField(blank=True, max_length=200, null=True, verbose_name='메뉴')),
